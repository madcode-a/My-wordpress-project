...
class Roofing_Flooring_Loader {
	 ...
	 * @return void
	 */
	public function roofing_flooring_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function roofing_flooring_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function roofing_flooring_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function roofing_flooring_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->roofing_flooring_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function roofing_flooring_load( $class ) {
